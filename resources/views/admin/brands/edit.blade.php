...
@section('content')
<form method="POST" action={{route('brands.update.submit',['id' => $dataItem->id])}}>
...
@endif
    ...
    @endif
      <div class="form-group">
        ...
        <input  type="text"  name="name" value="{{old('name') ? old('name') :$dataItem->name}}" class="form-control"  placeholder="Nhập tên thương hiệu" >
      </div>
      @error('name')
