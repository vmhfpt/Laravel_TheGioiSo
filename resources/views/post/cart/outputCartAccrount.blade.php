            ...
            @foreach ($dataCart as $value)
                <li>
                    <a class="sm-cart-product" href="product-details.html">
                        <img src="{{ url('storage/library/' .$value->getColor->thumb. '') }}" alt="">
                    </a>
                    <div class="small-cart-detail">
                        <a data-delete="{{$value->getColor->id}}" class="remove" href="#"><i class="fa fa-times-circle"></i></a>

                        <a class="small-cart-name" href="product-details.html">{{ $value->getColor->getProduct->name }}</a>
                        <span
